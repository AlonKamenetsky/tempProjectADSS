...
public class ProductRepositoryImpl implements IProductRepository {
    ...
    @Override
    public ProductDTO addProduct(String name, String companyName, String category) throws SQLException {
        ProductDTO newProduct = new ProductDTO(null, name, companyName, category);
